"""
This script extracts a bilingual dictionary between two foreign languages given bi-directional IBM model 1 parameters
between each foreign language and a common source language.
"""
import argparse
