...
"""
CHECK THE ANNOTATION MANUAL FOR POSSIBLE DELIMITERS OTHER THAN ' FOR SUFFIX SEPARATION
...
ANNOTATIONS_DIR = "./bolt_data/LDC2014E115_BOLT_LRL_Turkish_Representative_Language_Pack_V2.2/data/annotation/entity_annotation/simple/"

#DATA_LTF_DIR = "./actual_data/" #.ltf.xml files
DATA_XML_DIR = "./bolt_data/LDC2014E115_BOLT_LRL_Turkish_Representative_Language_Pack_V2.2/data/monolingual_text/ltf/"

# TRAIN_CONLL_FILE = "./conll_generated_files/turkish_train.conll"
# DEV_CONLL_FILE = "./conll_generated_files/turkish_dev.conll"
# TEST_CONLL_FILE = "./conll_generated_files/turkish_test.conll"
# RAW_TEXT_CORPUS = "./conll_generated_files/turkish_raw_text.txt"

TRAIN_CONLL_FILE = "./conll_generated_files/turkish_train_temp.conll"
DEV_CONLL_FILE = "./conll_generated_files/turkish_dev_temp.conll"
TEST_CONLL_FILE = "./conll_generated_files/turkish_test_temp.conll"
RAW_TEXT_CORPUS = "./conll_generated_files/turkish_raw_text_temp.txt"
